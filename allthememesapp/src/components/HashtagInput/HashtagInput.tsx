...
import {
  hashtagActions,
  selectIsHashtagsWarning,
  selectHashtagWarningMessage,
...
export const HashtagInput: FunctionComponent<Props> = ({
  addedHashtagsRef,
  allHashtags,
  disabled = false,
  ...
  const setAddedHashtags = useCallback(
    (hashtags: Set<string | never>) => {
  ...
  useEffect(() => {
    ...
    function clickHandler(event: Event) {
      ...
      if (
        ...
        event.target.className.includes('suggestion') &&
        !event.target.className.includes('suggestion-list')
      ) {
  ...
  return (
    <div
      className={classNames(
        ...
        styles['outer-input'],
        disabled
          ? inputStyles['input_disabled'] + ' ' + styles['outer-input_disabled']
          : '',
          ...
          >
            ...
            >
              <rect
                ...
                height="5.15772"
                rx="2.57886"
                transform="rotate(-45 0.000976562 58.353)"
                fill="white"
              />
              <rect
                x="3.64746"
                ...
                height="5.15772"
                rx="2.57886"
                transform="rotate(45 3.64746 6.10352e-05)"
                fill="white"
              />
            </svg>
          </button>
